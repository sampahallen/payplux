...
import { transfer } from "../../../constants/articles";
...
const Transfer = () => {
  return (
    <div>
      ...
      <Nav2
        title="Wallets"
        subtitle="How to Transfer from Cash-Out to Prepaid Wallet"
        link1="/support/Wallets"
        link2="/support/transfer"
      />
      <div className=" flex  items-center justify-center  ">
        <div className="pt-15 pb-20 px-3 lg:px-10 flex flex-col lg:flex-row w-full max-w-[530px] lg:max-w-[1000px] xl:max-w-[1200px] gap-25 lg:gap-10 xl:gap-20">
          <div className="font-latin px-5 flex flex-col gap-8 w-full max-w-[530px] xl:w-full">
            <h1 className="text-[#061F3C] font-medium text-[32px]">How to transfer from Cash-Out to Prepaid Wallet</h1>
