...
import { automatedPayments } from "../../constants/articles";
import { automatedPayment } from "../../constants/support";
...
const AutomatedPayments = () => {
  return (
    <div>
      <Navbar />
      <Nav title="Automated Payments" link="/support/automated-payments" />
...
export default AutomatedPayments;
