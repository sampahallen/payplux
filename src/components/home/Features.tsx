      ...
      <div>
        <div className="flex flex-col gap-14 lg:gap-8">
          <h1 className="font-latin  font-medium text-[30px] text-blue-950 text-center">
            The <span className="text-blue-500">best</span> experience always.
            You mean the most to us!
          </h1>
          ...
          <div className="relative lg:flex items-center justify-start flex-row hidden py-50 gap-10 lg:min-w-[900px] xl:min-w-[1150px] ">
            <div className="flex flex-col gap-7">
              {features.map((feature, index) => (
                <div
                  ...
                  className={`flex flex-row gap-8 items-center justify-center cursor-pointer ${
                    activeIndex === index
                      ? "bg-blue-500 py-4 pl-4 pr-8 rounded-sm"
                      : ""
                  }`}
                >
                  <img
                    src={feature.image}
                    alt=""
                    className="p-3 bg-white rounded-full shadow-[0px_2px_6px_2px_rgba(100,100,111,0.2)]"
                  />
                  <div className="flex flex-col">
                    <h1
                      className={`font-latin text-[16px] font-medium ${
                    ...
                    <p
                      className={`max-w-[300px] font-latin text-[16px]  ${
                        activeIndex === index
                          ? "text-gray-200"
                          : "text-slate-500"
                      }`}
            ...
            <div className="flex items-center">
              <img
                src={features[activeIndex].main}
                alt=""
                className="absolute w-[1100px] h-[900px]"
              />
            </div>
          </div>
        </div>
