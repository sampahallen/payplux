...
const Info = () => {
  return (
    <section className="bg-gray-50 mt-45 py-20">
      <div className="flex flex-col md:flex-row items-center justify-center px-4 md:px-15 md:gap-5">
        <div className="flex flex-col gap-5 md:gap-9">
          ...
          <p className="text-[17px] font-normal text-slate-500">
      ...
      <div className="flex flex-col md:flex-row-reverse px-4 mt-30 text-slate-950 md:px-15 md:gap-5">
        <div className="flex flex-col gap-4">
          ...
          <div className="mb-5">
            {steps.map((item) => (
              <div className="flex gap-4 text-slate-500 items-center mt-4">
