...
const Navbar = () => {
  ...
  return (
    <section className="fixed flex flex-col items-center justify-center top-0 left-0 w-full z-1000 bg-white">
      <div className="">
        <div className="flex flex-row justify-between items-center min-w-[360px] xs:min-w-[500px]  md:min-w-[900px] lg:min-w-[1100px] xl:min-w-[1450px]  max-sm:px-5 md:px-25 lg:px-[11%] px-4 py-6 ">
