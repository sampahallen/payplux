...
const Navbar = () => {
  ...
  return (
    <section className="fixed top-0 left-0 w-full z-1000 bg-white">
      <div className="flex flex-row justify-between items-center max-sm:px-5 md:px-25 lg:px-[11%] px-4 py-6 pr-40">
        ...
        <div className="sm:flex  md:items-center md:justify-center md:gap-8">
          ...
          <nav className="lg:hidden">
            ...
            <span
              className={`${istoggle?'':'hidden'} text-2xl font-bold text-gray-800 cursor-pointer`}
              role="button"
