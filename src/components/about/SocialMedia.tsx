...
const SocialMedia = () => {
  return (
    <section className="flex flex-col md:items-center md:justify-center pb-30 md:py-20 xl:py-0 xl:pb-30">
        <div className="flex flex-col px-4 md:min-w-[600px] md:max-w-[1300px] gap-5 md:gap-10 xl:gap-15">
            <h1 className="text-[30px] md:text-center font-medium"><span className="text-blue-500">Connect</span> with us on Social Media</h1>
