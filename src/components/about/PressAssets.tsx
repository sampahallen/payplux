...
const PressAssets = () => {
  return (
    <section className="flex items-center justify-center py-20 xl:min-h-screen">
      <div className="flex flex-col gap-7 px-5 md:text-center md:w-[850px] lg:w-[900px]">
        <h1 className="text-[28px] md:text-[31px] font-semibold">
          Press Assets
        </h1>
        <p className="text-[18px] md:text-[19px] lg:text-[20px] xl:text-[20px] leading-[30px] md:leading-[30px] lg:leading-[35px] text-slate-500">
        ...
        <div className="flex items-center justify-center text-blue-500 text-[18px] lg:text-[19px] ">
