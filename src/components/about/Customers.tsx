...
const Customers = () => {
  return (
    <section className="bg-gray-50 flex flex-col  items-center justify-center px-10 pt-4 md:pt-1 xl:pt-70 pb-20 md:pb-15 xl:pb-30 mt-6">
      <div className="flex flex-col md:flex-row  md:items-center min-w-[450px] max-w-[500px] md:min-w-[700px] lg:min-w-[900px] xl:min-w-[1150px]">
        <div className="flex flex-col gap-10 md:w-[50%]">
          ...
          <p className="text-[17.5px] md:text-[19px] md:max-w-[300px] lg:max-w-[360px] xl:max-w-[520px] lg:text-[18px] xl:text-[20px]  md:leading-[30px] lg:leading-[40px] text-slate-500 tracking-wide ">
