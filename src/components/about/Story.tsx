const Story = () => {
  return (
    <section className="flex items-center justify-center md:px-5 md:min-h-screen pt-[130px] lg:pt-20">
        <div className="flex flex-col md:flex-row md:items-center w-[500px] md:w-[750px] lg:w-[920px] xl:w-[1300px] gap-15 md:gap-10">
            <h1 className="text-[120px] xl:text-[250px] md:w-[50%] lg:w-[30%] xl:w-[50%] font-bold leading-[110px] xl:leading-[200px]">Our <br /><span className="text-blue-500">Story</span></h1>
            <div className="flex flex-col md:w-[50%] lg:w-[70%] xl:w-[50%] gap-10 text-[17.5px] md:text-[15px] lg:text-[18.5px] md:leading-[30px] lg:leading-[40px] text-slate-500 tracking-wide px-4">
